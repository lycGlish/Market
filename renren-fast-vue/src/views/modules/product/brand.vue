    ...
    <el-table :data="dataList"
      ...
      <el-table-column fixed="right"
        ...
        <template slot-scope="scope">
          <el-button type="text"
                     size="small"
                     @click="updateCatalogHandle(scope.row.brandId)">关联分类</el-button>
          <el-button type="text"
                     size="small"
    ...
    <el-dialog title="关联分类"
      ...
      <el-popover placement="right-end"
        ...
        <div style="text-align: right; margin: 0">
          <el-button size="mini"
                     type="text"
                     @click="popCatalogSelectVisible = false">取消</el-button>
          <el-button type="primary"
                     size="mini"
                     @click="addCatalogSelect">确定</el-button>
        </div>
