      ...
      <div class="mod-config">
        <el-form :inline="true"
          ...
          <el-form-item>
            ...
            <el-button v-if="isAuth('product:attr:save')"
                       type="primary"
                       @click="addOrUpdateHandle()">新增</el-button>
            <el-button v-if="isAuth('product:attr:delete')"
                       type="danger"
                       @click="deleteHandle()"
        ...
        <el-table :data="dataList"
          ...
          <el-table-column prop="valueType"
            ...
            <template slot-scope="scope">
              <el-tag type="success"
                      v-if="scope.row.valueType==0">单选</el-tag>
          ...
          <el-table-column prop="valueSelect"
                           header-align="center"
                           align="center"
                           label="可选值">
            <template slot-scope="scope">
          ...
          <el-table-column fixed="right"
            ...
            <template slot-scope="scope">
              ...
              <el-button type="text"
                         size="small"
                         @click="deleteHandle(scope.row.attrId)">删除</el-button>
            </template>
          </el-table-column>
        </el-table>
