...
import com.lyc.market.product.dao.BrandDao;
...
import com.lyc.market.product.dao.CategoryBrandRelationDao;
...
public class CategoryBrandRelationServiceImpl extends ServiceImpl<CategoryBrandRelationDao, CategoryBrandRelationEntity>
    ...
    public List<BrandEntity> getBrandsByCatId(Long catId) {
        List<CategoryBrandRelationEntity> catalog_id = relationDao.selectList(
                new QueryWrapper<CategoryBrandRelationEntity>().eq("catalog_id", catId));
        List<BrandEntity> collect = catalog_id.stream().map((item) -> {
